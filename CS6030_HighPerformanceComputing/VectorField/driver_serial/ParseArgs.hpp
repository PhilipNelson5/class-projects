...
auto parse_args(int argc, char** argv)
{
    ...
    options.add_options()
        ...
        ("i,image_scale_factor", "Number of times larger to make the output image than the input field", cxxopts::value<int>()->default_value("4"))
    ...
    try {
        ...
        return Args { nCurves, maxCurveLen, imgScaleFactor, vfH, vfW, inputFileName, makeImage };

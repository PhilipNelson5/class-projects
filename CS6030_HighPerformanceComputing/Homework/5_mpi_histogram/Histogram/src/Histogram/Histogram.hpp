...
/**
 * @brief calculate the histogram of the input data set [first, last)
 * 
 * @tparam T the type of the input data
 * @tparam ForwardIt 
 * @param first iterator at first element, inclusive
 * @param last iterator at last element, exclusive
 * @param bin_count number of bins
 * @param bin_maxes a vector containing the maximin value of each bin
 * @return [bin_maxes, bin_counts]: vector of bin maxes, vector of bin counts
 */

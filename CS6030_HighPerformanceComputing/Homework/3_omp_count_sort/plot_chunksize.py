...
timings = pd.read_csv("./data/timings_chunksize_1-100.csv", skipinitialspace=True)
print(timings)
print(timings[timings.time_ms == timings.time_ms.min()])

sns.lineplot(data=timings, x="chunksize", y="time_ms")
plt.xlabel("chunksize")
plt.ylabel("time (ms)")
plt.tight_layout()
plt.savefig("./images/chunksize_1-100.png")
